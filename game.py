...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Mustang GT')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Natain Bogdan", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("https://github.com/Natain", True, self.white)
